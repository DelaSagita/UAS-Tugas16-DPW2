...
<body>
 ...
 @include('client.section.header')
            ...
            <div class="row">
              <div class="col-md-6 col-lg-5">
                <div class="detail-box">
                  ...
                  <p>
                   Ingin tampil menarik dan trendy?Ayo kunjungi DS. WOMEN'S SHOES!</p>
                  <div class="btn-box">
                    <a href="" class="btn-1">
                      Read More
                    </a>
        ...
        <div class="carousel-item">
          <div class="container ">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-7">
                <div class="img-box">
                  <img src="{{url('public')}}/app/images/slider1-img..jpg" alt="">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="carousel-item">
          <div class="container ">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-7">
                <div class="img-box">
                  <img src="{{url('public')}}/app/images/slider2-img.jpg" alt="">
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="product_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          Pilihan model, merk, warna dan ukuran tersedia disini, Tinggal anda yang memilih. 
        </p>
      </div>
      <div class="row">
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/app/images/p1.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/app/images/p2.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/app/images/p3.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/app/images/p4.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/app/images/p5.png" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/app/images/p6.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-10 mx-auto">
                  <div class="box">
                    <div class="img-box">
                      <img src="{{url('public')}}/app/images/client1.jpg" alt="">
                    </div>
                    <div class="detail-box">
                      ...
                      <p>
                         Kualitas barangnya bagus banget sesuai juga dengan yang di pesan Aaaaah seneng pokoknya. 
                         Recommend banget dengan toko ini.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-10 mx-auto">
                  <div class="box">
                    ...
                    <div class="detail-box">
                      ...
                      <p>
                        Sepatu snekernya keren! enak dipakai, adik ku suka banget dengan sepatunya 
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        &copy; <span id="displayYear"></span> Women's shoes By
        <a href="/">DS. WOMEN'S SHOES</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
