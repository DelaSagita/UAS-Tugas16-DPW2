...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{ url('shoes') }}">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><a href="{{ url('cart') }}">Cart</a></strong></div>
        </div>
      </div>
    </div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    ...
                    <img src="{{url('public')}}/app/images/p5.png" alt="Images" width="20%">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Socious</h2>
                    </td>
                    <td>RP.500.000</td>
                    <td>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                    <img src="{{url('public')}}/app/images/p7.png" alt="Images" width="20%">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Fila</h2>
                    </td>
                    <td>RP.469.000</td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
              ...
              <div class="col-md-7">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    <strong class="text-black">RP.969.000</strong>
                  </div>
                </div>
                <div class="row mb-5">
                  <div class="col-md-6">
